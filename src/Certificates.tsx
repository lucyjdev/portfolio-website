  ...
  return (
    <div className="container">
      ...
      <div className="container-fluid">
        ...
        <h3 className="certificate-heading">SheCodes Introduction to Coding</h3>
        ...
        <p className="certificate-para">
          I learnt about React components, events, states, forms and properties
          in the first part of the course and conditional rendering, loops, AJAX
          and external components in later weeks.
        </p>
        <p className="certificate-para">
        ...
        <p className="certificate-para">
          ...
          between July and December 2021. This course
          covered concepts of Object Oriented Programming, control structures,
          data structures, software design, networking, persistent local data
          storage, implementing In-App Purchases with Apple StoreKit, machine
          learning, augmented reality and SwiftUI.
        </p>
        <p className="certificate-para">
          {" "}
          I have had experience building over 20 apps as part of this course and
          I have since started to develop an iOS collaborative events calendar
          app and a timer app developing on the skills I learned during the
          bootcamp.
        </p>
        <a
          className="link"
