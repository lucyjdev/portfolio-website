        ...
        <div className="info-para">
            ...
            <div className="row" id="certificate-rows">
              ...
              <div className="col">
                ...
                <p>
                  ...
                  link to my final project can be found under the projects
                  section above.
                </p>
          ...
          <div className="row" id="certificate-rows">
            <div className="col">
              ...
              <p>
                The SheCodes React workshop covered HTML, CSS, Javascript,
                GitHub, Bootstrap and APIs in more detail and introduced React.
              </p>
              <p>
              ...
              <p>
                ...
                debugging and React hosting. My final project involved building
                my weather app in React and this can be found under the projects
                section above.
              </p>
          ...
          <div className="row" id="certificate-rows">
            ...
            <div className="col">
              ...
              <p>
                I started this course in April 2021 as a complete beginner to
                iOS app development. To learn more about my journey to Swift
                please check out the 'About Me' section above.
              </p>
              <p>
                {" "}
                I have had experience building over 20 apps as part of this
                course from basic calculator and timer apps to AR apps. I am now
                working on my own app to deploy to the app store. Further
                details on the idea behind my app and my progress can be found
                under the projects section above.
              </p>
              <p>
                For further details on the modules covered in this course,
                please see the{" "}
