      ...
      <div className="container">
        ...
        <div className="info-para">
          ...
          <p>
            ...
            workshop, I couldn't wait to start learning. Six months on and I had
            completed the SheCodes beginner workshop, SheCodes Plus workshop and
            SheCodes React workshop. Links to my certificates and final projects
            can be found on the links at the top of this page, and further
            information on the workshops and course content can be found{" "}
            <a className="link" href="https://www.shecodes.io/">
              here
            </a>
            .
          </p>
          <p>
            ...
            to focus on further developing my skills and to move into a career
            in web or app development. This bootcamp has been a great
          ...
          <p>
            For more information on my career and work experience please take a
            look at my{" "}
            <a
              className="link"
